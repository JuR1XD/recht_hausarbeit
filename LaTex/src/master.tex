...
\Matrikelnummer{8226886}
\Studiengangsleiter{Prof. Dr. Thomas Holey}
\Bearbeitungszeitraum{24.05.2023 -- 06.06.2023}
...
\input{einzelne_handelsgeschaefte}
\input{lager_und_transportgeschaefte}
\input{fracht_und_speditionsvertrag}
% Fazit und Ausblick
\input{conclusion}
